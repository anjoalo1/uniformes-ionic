...
import { precios, tallas, tipoPrenda } from 'src/app/archives/arrays';

@Component({
  selector: 'app-cfactura',
  templateUrl: './cfactura.component.html',
  styleUrls: ['./cfactura.component.scss'],
})
export class CfacturaComponent  implements OnInit {
